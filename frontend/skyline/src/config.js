...
export default angular.module('skyline.config', dependencies)
  .value('SERVER_USE_EXTERNAL_NETWORK', !CONST.floating_ips)
  .value('SHOW_DISK_SIZE_IN_FLAVOR', !CONST.manual_disk_size)
  .config(function (RestangularProvider, $locationProvider, $translateProvider, CONST, $httpProvider, ngClipProvider, tmhDynamicLocaleProvider, $provide) {
    ...
    tmhDynamicLocaleProvider.localeLocationPattern('/skyline/angular-locale_{{locale}}.js');
