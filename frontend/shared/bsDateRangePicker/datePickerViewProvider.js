  ...
  .provider('datepickerViews', function () {
    ...
    this.$get = function ($dateFormatter, $dateParser, $sce) {
      return function (picker) {
        ...
        var views = [{
          ...
          build: function () {
            ...
            for (var i = 0; i < 42; i++) {
              ...
              days.push({
                ...
                greater: picker.$date && this.isGreater(day),
                less: picker.$date && this.isLess(day),
          ...
          isGreater: function (date) {
            return picker.$date && date.getFullYear() === picker.$date.getFullYear() && (date.getMonth() > picker.$date.getMonth() || (date.getMonth() === picker.$date.getMonth() && date.getDate() > picker.$date.getDate()));
          },
          isLess: function (date) {
            return picker.$date && date.getFullYear() === picker.$date.getFullYear() && (date.getMonth() < picker.$date.getMonth() || (date.getMonth() === picker.$date.getMonth() && date.getDate() < picker.$date.getDate()));
          },
    ...
    this.$get = ['$window', '$document', '$rootScope', '$sce', '$dateFormatter', 'datepickerViews', '$tooltip', '$timeout', function ($window, $document, $rootScope, $sce, $dateFormatter, datepickerViews, $tooltip, $timeout) {
      ...
      function DatepickerFactory(element, controller, config) {
        ...
        $datepicker.$isGreater = function (date) {
          return $picker.isGreater ? $picker.isGreater(date) : false;
        };
        $datepicker.$isLess = function (date) {
          return $picker.isLess ? $picker.isLess(date) : false;
        };
        ...
        function updateSelected(el) {
          ...
          el.greater = $datepicker.$isGreater(el.date);
          el.less = $datepicker.$isLess(el.date);
        }
    ...
    $templateCache.put('datepicker/datepicker.tpl.html', require('./datepicker.tpl.html'));
  });
