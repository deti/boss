...
class RedisSentinelBackend(RedisBackend):
    ...
    def __init__(self, sentinels=None, sentinel_timeout=None, socket_timeout=None,
        ...
        self.min_other_sentinels = min_other_sentinels or _get("MIN_OTHER_SENTINELS") or 0
...
def register_celery_alias(alias="redis-sentinel"):
    BACKEND_ALIASES[alias] = "task.sentinel.RedisSentinelBackend"
    TRANSPORT_ALIASES[alias] = "task.sentinel.RedisSentinelTransport"
